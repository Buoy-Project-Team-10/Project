...
for(i in 1:12){
  ...
  geom_smooth(mapping = aes(x=YYYY,y=WTMP)) + 
  ggtitle(paste("Aver. Water Temp. of M",i,sep=""))))
}
```
...
```
  ...
  It is very interesting to look at the plot of water temperature. The average water temperature of Q3 is shown that there was a drastic decrease  since 2010, while compared to air temperature, there was a drastic increase in quarter 3 since 2010. However, in other quarters of the year, air temperature and water temperature didn't show a significant negative correlation. This might leads to further exploration in the variation of a
...
ir temperature and the correlation with water temperature.
```{r}
# Fit the model of Air Temp.
...
From the plots shown above, the average air temperature over these 30 years did show an increasing tendency, no matter in quarterly scale or monthly scale. However, it seems that further information is still to be interpreted and explored, since we found out some interesting correlation between average water temperature and average air temperature. Also, the reason behind the variation of average air temperature is valuable to be digged in. 