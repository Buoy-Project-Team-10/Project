...
head(raw_buyo)
```
### 2.1 Transform variables, drop meaningless columns
...
summary(buyo)
```
### 2.2 Conduct the imputation of NA and anomaly data
...
## 2.3  Transform the date-time data into posix numbers using lubridate
